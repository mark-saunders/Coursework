...
class TKinter_screen(Tk):
    ...
    def create_options(self):
        _1 = OptionMenu(self, self.option_var, *self.options).grid(row=3, column=4)
        _2 = OptionMenu(self, self.option_var, *self.options).grid(row=3, column=5)
        _3 = OptionMenu(self, self.option_var, *self.options).grid(row=3, column=6)
        _4 = OptionMenu(self, self.option_var, *self.options).grid(row=4, column=4)
        _5 = OptionMenu(self, self.option_var, *self.options).grid(row=4, column=6)
        _6 = OptionMenu(self, self.option_var, *self.options).grid(row=5, column=4)
        _7 = OptionMenu(self, self.option_var, *self.options).grid(row=5, column=5)
        _8 = OptionMenu(self, self.option_var, *self.options).grid(row=5, column=6)
